 ...
 */
class TermSysType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TermSysType';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['term_type'] === null) {
            $invalidProperties[] = "'term_type' can't be null";
        }
     ...
     * Sets school_year
     *
     * @param int|null $school_year school_year
     *
     * @return self
     */
     ...
     * Sets term_type
     *
     * @param string $term_type term_type
     *
     * @return self
     */
    public function setTermType($term_type)
    {
        if (is_null($term_type)) {
            throw new \InvalidArgumentException('non-nullable term_type cannot be null');
        }
