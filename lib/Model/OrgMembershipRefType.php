...
/**
 * OrgMembershipRefType Class Doc Comment
 *
 * @category Class
 * @package  Kimono
 * @author   OpenAPI Generator team
 ...
 */
class OrgMembershipRefType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrgMembershipRefType';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['org_type'] === null) {
            $invalidProperties[] = "'org_type' can't be null";
        }
     ...
     * Sets org_type
     *
     * @param string $org_type org_type
     *
     * @return self
     */
