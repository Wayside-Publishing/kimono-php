 ...
 */
class ErrorType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ext_message', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['ext_message'];
    }

    /**
     * Sets ext_message
     *
     * @param string|null $ext_message Extended error message
     *
     * @return self
     */
    public function setExtMessage($ext_message)
    {
        if (is_null($ext_message)) {
            throw new \InvalidArgumentException('non-nullable ext_message cannot be null');
        }
        $this->container['ext_message'] = $ext_message;
