...
class GradesApi
{
     ...
     */
    public function listGradingCategories($page = null, $page_size = null)
    {
        list($response) = $this->listGradingCategoriesWithHttpInfo($page, $page_size);
        return $response;
    }
     ...
     */
    public function listGradingCategoriesWithHttpInfo($page = null, $page_size = null)
    {
        $request = $this->listGradingCategoriesRequest($page, $page_size);
     ...
     */
    public function listGradingCategoriesAsync($page = null, $page_size = null)
    {
        return $this->listGradingCategoriesAsyncWithHttpInfo($page, $page_size)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listGradingCategoriesAsyncWithHttpInfo($page = null, $page_size = null)
    {
        $returnType = '\Kimono\Model\GradingCategorysResponse';
        $request = $this->listGradingCategoriesRequest($page, $page_size);
     ...
     */
    protected function listGradingCategoriesRequest($page = null, $page_size = null)
    {
