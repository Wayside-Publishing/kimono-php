...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.us2.kimonocloud.com/v2/interop/data';
    ...
    {
        $report  = 'PHP SDK (Kimono) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return array(
          array(
            "url" => "https://api.us2.kimonocloud.com/v2/interop/data",
